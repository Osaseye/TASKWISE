...
const recurringCode = `import React, { useEffect } from 'react';
...
fs.writeFileSync('c:/Users/User/OneDrive/Desktop/TASKWISE/TASKWISE/Taskwise/src/components/dashboard/RecurringTaskModal.jsx', recurringCode);
