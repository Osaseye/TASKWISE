  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <button 
        ...
        className="group relative flex items-center justify-center w-12 h-12 bg-gradient-to-br from-[#1ec9d2] to-[#169ea5] rounded-full shadow-[0_4px_20px_rgba(30,201,210,0.4)] hover:shadow-[0_4px_30px_rgba(30,201,210,0.6)] hover:-translate-y-1 transition-all duration-300"
      >
